    ...
    >
      <div className="bg-[#144794] w-full max-w-[393px] min-h-[852px] relative">
        ...
        <div className="absolute w-[260px] h-[250px] top-[529px] left-1/2 transform -translate-x-1/2 bg-[#e9fcff] rounded-[25px] border border-solid border-[#1be8ff]">
          <input className="absolute w-[100px] h-20 top-[75px] left-9 bg-[#fffefe] rounded-[10px] border border-solid border-[#f45c5c]"/>
          <div className="absolute w-[88px] h-[60px] top-[97px] left-[141px]">
            <div className="absolute w-20 h-[60px] top-0 left-4 font-mkpop text-[#144794] text-2xl text-center tracking-[0] leading-[normal]">
              {data.goalNumber}{data.goalUnit}
            </div>

            <img
              className="absolute w-[19px] h-[31px] top-[0px] left-0"
              alt="Line"
          ...
          <button className="absolute w-[195px] h-10 top-[185px] left-[33px] bg-[#1be8ff] rounded-[10px] active:scale-95 active:shadow-inner hover:bg-blue-500">
            <div className="w-[104px] h-[15px] top-[11px] left-[47px] [font-family:'Inter',Helvetica] text-xs text-center absolute font-inter text-[#144794] tracking-[0] leading-[normal] ">
              記録する
            </div>
          </button>
        </div>
